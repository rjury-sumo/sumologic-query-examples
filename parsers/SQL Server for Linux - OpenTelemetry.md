...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Backup Failure Reasons**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Backup Failures**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Database Backed Up**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Mirroring Errors**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Restore Activity**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Backup Restore Mirroring/Transaction Log Backed Up**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} db.node.name={{db.node.name}}  sumo.datasource=sqlserver backup | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
...
**SQL Server for Linux - OpenTelemetry/SQL Server - General Health/AppDomain Issues**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - General Health/Insufficient Space Issues**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - General Health/Server Events**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - General Health/Stopped Servers**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} db.node.name={{db.node.name}} sumo.datasource=sqlserver |json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw
| where _raw matches "*SQL Server is now ready for client connections.*" or  _raw matches "*SQL Server is allowing new connections in response to 'continue' request from Service Control Manager.*" or  _raw matches "*SQL Server is not allowing new connections because the Service Control Manager requested a pause*" or  _raw matches "*SQL Trace was stopped due to server shutdown.*" or "*SQL Server terminating because of system shutdown.*"
...
**SQL Server for Linux - OpenTelemetry/SQL Server - General Health/Up Servers**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} db.node.name={{db.node.name}} sumo.datasource=sqlserver |json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw
| where _raw matches "*SQL Server is now ready for client connections.*" or  _raw matches "*SQL Server is allowing new connections in response to 'continue' request from Service Control Manager.*" or  _raw matches "*SQL Server is not allowing new connections because the Service Control Manager requested a pause*" or  _raw matches "*SQL Trace was stopped due to server shutdown." or "SQL Server terminating because of system shutdown.*"
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Operations/Configuration Update Trend**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Operations/Configuration Updates**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} db.node.name={{db.node.name}} sumo.datasource=sqlserver option | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
| parse "Configuration option '*' changed from * to *." as object, old_val, new_val nodrop
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Operations/Error Trend?by Severity Code**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Operations/Errors and Warnings**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Operations/Recent Configuration Updates**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} db.node.name={{db.node.name}} sumo.datasource=sqlserver option | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
| parse "Configuration option '*' changed from * to *." as object, old_val, new_val nodrop
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Appdomain Issue count**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Backup Failure Count**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Error or Warning Count**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Insufficient space issues Count**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Login Failure Reasons**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Login Failures**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}}  sumo.datasource=sqlserver Logon | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
| parse "Logon       Login * for user '*'. Reason: * '*'. [CLIENT: *]" as logon_status, userName, reason, database, client_ip nodrop
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Logins by Authentication Method**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Mirroring Error Count**
```
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Top 10 Client IP Addresses by Login Count**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}}  sumo.datasource=sqlserver Logon succeeded | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
| parse "Logon       Login * for user '*'. Connection made using *. [CLIENT: *]" as logon_status, userName, authentication_method, client_ip 
...
**SQL Server for Linux - OpenTelemetry/SQL Server - Overview/Top 10 Users by Login Count**
```
 db.cluster.name={{db.cluster.name}} deployment.environment={{deployment.environment}} sumo.datasource=sqlserver Logon succeeded | json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as _raw 
| parse "Logon       Login * for user '*'. Connection made using *. [CLIENT: *]" as logon_status, userName, authentication_method, client_ip 
