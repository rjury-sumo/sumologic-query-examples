...
**Zscaler Internet Access/ZIA - Behavior/Destination vs Source Volume by Category**
```
_sourceCategory={{Logsdatasource}}  "Allowed" 
...
**Zscaler Internet Access/ZIA - Behavior/General Activity by Super Category and Sub Category**
```
_sourceCategory={{Logsdatasource}}  "general browsing" "Allowed"
...
**Zscaler Internet Access/ZIA - Behavior/General Browsing by Location**
```
_sourceCategory={{Logsdatasource}}  "general browsing" "Allowed"
| json field=_raw "event.clientpublicIP", "event.user", "event.location" as src_ip, src_user, location
```

**Zscaler Internet Access/ZIA - Behavior/MB In by Top 5 Countries**
```
_sourceCategory={{Logsdatasource}}  "Allowed" 
...
**Zscaler Internet Access/ZIA - Behavior/MB Out by Top 5 Countries**
```
_sourceCategory={{Logsdatasource}}  "Allowed" 
...
**Zscaler Internet Access/ZIA - Behavior/Non-General Activity by App Class**
```
_sourceCategory={{Logsdatasource}}  !"general browsing" //ensure no nones and nulls
| json field=_raw "event.clientpublicIP", "event.user", "event.appclass" as src_ip, src_user, appclass
```

**Zscaler Internet Access/ZIA - Behavior/Non-General Activity by App Name**
```
_sourceCategory={{Logsdatasource}}  !"general browsing" //ensure no nones and nulls
| json field=_raw "event.clientpublicIP", "event.user", "event.appname" as src_ip, src_user, application
```

**Zscaler Internet Access/ZIA - Behavior/Non-General Activity Top Named Users**
```
_sourceCategory={{Logsdatasource}}  !"general browsing" //ensure no nones and nulls
| json field=_raw "event.clientpublicIP", "event.user" as src_ip, src_user
```

**Zscaler Internet Access/ZIA - Behavior/Top General Browsing by Named Users**
```
_sourceCategory={{Logsdatasource}}  "general browsing" //ensure no nones and nulls
| json field=_raw "event.clientpublicIP", "event.user" as src_ip, src_user
```

**Zscaler Internet Access/ZIA - Blocked Traffic/Blocked Events Outliers**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.action" as src_ip, src_user, category, action
```

**Zscaler Internet Access/ZIA - Blocked Traffic/Outliers by Blocked Users**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Blocked Traffic/Top 10 Blocked Base URLs**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Blocked Traffic/Top 10 Blocked Locations**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.location", "event.action" as src_ip, src_user, location, action
```

**Zscaler Internet Access/ZIA - Blocked Traffic/Top 10 Blocked URL Categories**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Blocked Traffic/Top 10 Blocked Users**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.action" as src_ip, src_user, category, action
```

**Zscaler Internet Access/ZIA - Blocked Traffic/Top 10 Reasons**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - DNS/Allowed Requests**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - DNS/Allowed Response**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Denied Requests**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Denied Response**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Logs by Category**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Server Locations**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Top 10 Requested URLs**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - DNS/Top 10 Slowest URLs**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.department", "event.location", "event.reqaction", "event.resaction", "event.reqrulelabel", "event.resrulelabel", "event.dns_req", "event.dns_reqtype" , "event.dns_resp", "event.durationms", "event.srv_dip", "event.clt_sip", "event.category"  as user, department, location, reqaction, resaction, reqrulelabel, resrulelabel, dns_req, dns_reqtype, dns_resp, durationms, srv_dip, clt_sip, category
```

**Zscaler Internet Access/ZIA - File Classification Activity/File Based Threats Outlier**
```
...
**Zscaler Internet Access/ZIA - File Classification Activity/File Threats by Risk Score**
```
_sourceCategory={{Logsdatasource}}   filetype
...
**Zscaler Internet Access/ZIA - File Classification Activity/File Threats By User**
```
_sourceCategory={{Logsdatasource}}   filetype
| json field=_raw "event.clientpublicIP", "event.user", "event.filetype", "event.threatname" as src_ip, src_user, filetype, threatname
```

**Zscaler Internet Access/ZIA - File Classification Activity/Threats by App**
```
_sourceCategory={{Logsdatasource}}   filetype
...
**Zscaler Internet Access/ZIA - File Classification Activity/Threats by File Class**
```
_sourceCategory={{Logsdatasource}}   filetype
...
**Zscaler Internet Access/ZIA - File Classification Activity/Threats by File Types**
```
_sourceCategory={{Logsdatasource}}   filetype
| json field=_raw "event.clientpublicIP", "event.user", "event.filetype", "event.threatname", "event.fileclass" as src_ip, src_user, filetype, threat, fileclass
```

**Zscaler Internet Access/ZIA - Logs/DNS Logs**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Logs/Firewall Logs**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Logs/Logs by Source**
```
_sourceCategory={{Logsdatasource}} 
| json "sourcetype", "event.user" as sourcetype, user
```

**Zscaler Internet Access/ZIA - Logs/Tunnel Logs**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Logs/Web Logs**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Overview/Blocked Traffic**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.urlcategory", "event.action", "event.user" as category, action, user
```

**Zscaler Internet Access/ZIA - Overview/Denied Events**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Overview/Denied to Allowed Ratio**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Overview/Denied to Allowed Ratio - Outlier**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Overview/File Classification Threats**
```
_sourceCategory={{Logsdatasource}}   filetype
| json field=_raw "event.filetype", "event.threatname", "event.user" as filetype, threatname, user
```

**Zscaler Internet Access/ZIA - Overview/Location of Allowed Activities**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Overview/Location of Denied Activites**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.action" as src_ip, src_user, action
```

**Zscaler Internet Access/ZIA - Overview/Logs by Source**
```
_sourceCategory={{Logsdatasource}} 
| json "sourcetype", "event.user" as sourcetype, user
```

**Zscaler Internet Access/ZIA - Overview/Protocol Transports Over Time**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.protocol", "event.user" as protocol, src_user
```

**Zscaler Internet Access/ZIA - Overview/Threats Submitted to Sandbox**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Overview/Tunnel Events**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Overview/Users Over Time**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.user", "event.location" as src_user, location
```

**Zscaler Internet Access/ZIA - Threats/Advanced Security Risk Categories**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Threats/Advanced Security Risks by Category and Location**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Threats/Advanced Security Risks by Category and Users**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Authenticated Users Blocked**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Authenticated Users Blocked Over Time**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Locations Blocked**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Locations Blocked Over Time**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Threat Categories**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.threatcategory" as src_ip, src_user, category, reason, urlclass, threatname, threatcategory
```

**Zscaler Internet Access/ZIA - Threats/Threats by Location and Category**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.threatcategory", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, threatcategory, location
```

**Zscaler Internet Access/ZIA - Threats/Threats by User and Category**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.threatcategory", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, threatcategory, location
```

**Zscaler Internet Access/ZIA - Threats/Transactions**
```
_sourceCategory={{Logsdatasource}} 
...
**Zscaler Internet Access/ZIA - Threats/Transactions Allowed**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Transactions Blocked**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location" as src_ip, src_user, category, reason, urlclass, threatname, location
```

**Zscaler Internet Access/ZIA - Threats/Transactions Over Time**
```
_sourceCategory={{Logsdatasource}} 
| json field=_raw "event.clientpublicIP", "event.user", "event.urlcategory", "event.reason", "event.urlclass", "event.threatname", "event.location", "event.action" as src_ip, src_user, category, reason, urlclass, threatname, location,action
```
