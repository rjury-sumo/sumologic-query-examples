...
**HAProxy/Error Log Analysis/Backend Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy backend
...
**HAProxy/Error Log Analysis/Client Locations with Critical Errors**
```
proxy_cluster=* proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
| parse regex field=haproxy_log_message "(?<syslog_host>.*)\]:\s+" nodrop
...
**HAProxy/Error Log Analysis/Critical Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
| parse regex field=haproxy_log_message "(?<syslog_host>.*)\]:\s+" nodrop
| parse regex field=haproxy_log_message ":\s+(?<c_ip>[\w\.]+):(?<c_port>\d+)\s+" nodrop
...
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy Server
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
| parse regex field=haproxy_log_message "(?<syslog_host>.*)\]:\s+" nodrop
...
**HAProxy/Error Log Analysis/Top 5 Clients Causing Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Outlier Analysis/Bytes Served - Outlier**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Outlier Analysis/Client Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Outlier Analysis/Number of Visitors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Outlier Analysis/Server Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Overview/Responses Over Time**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Overview/Top 5 URLs with Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Overview/Visitor Locations**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Highly Malicious Threats**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Threat Count**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Threat Locations**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Threats by Actors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Threats by Malicious Confidence**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Threats by Source**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Top 10 Threats**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Threat Analysis/Top 5 Highly Malicious URLs**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Trends/Number of Hits by Server - One Day Time Comparison**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Trends/Responses Over Time**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Trends/Traffic Distribution by Server**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Trends/Traffic Volume and Bytes Served**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Trends/Visitor Locations - One Day Time Comparison**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Access Types/Client Locations - 4xx Errors**
```
proxy_cluster=* proxy_system=haproxy proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Access Types/Non 200 Response Status Codes**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Access Types/Top 5 Clients Causing 4xx Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Access Types/Top 5 URLs Causing 4xx Responses**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Access Types/Visitor Platforms**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Locations/United States**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Locations/Visits by Country Over Time**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Locations/Visits by US Regions Over Time**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Locations/Worldwide**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Traffic Insight/Bytes Served**
```
proxy_cluster=* proxy_system=haproxy proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Traffic Insight/HTTP Methods**
```
proxy_cluster=* proxy_system=haproxy proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Traffic Insight/Media Types Served**
```
proxy_cluster=* proxy_system=haproxy  proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Traffic Insight/Top 10 Search Terms from Popular Search Engines**
```
proxy_cluster=* proxy_system=haproxy proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
| parse regex field=haproxy_log_message "\s+\{(?<request_headers>.*)\}\s+" nodrop
| parse regex field=haproxy_log_message "\s+\"(?<http_request>.*)\"" nodrop
|parse regex field=request_headers "(?<referrer>\S+)\|(?<user_agent>[^\"]*)"
| parse regex field=http_request "(?<method>\w+)\s+(?<request>[^\"]*)\s+(?<http_version>\w+)"
| parse regex field=referrer "(?:\?|&)(?:p|q|wd|searchfor)=(?<search_term>[^=]+?)(?:&|$)" nodrop 
```

**HAProxy/Visitor Traffic Insight/Top 5 Referrers**
```
proxy_cluster=* proxy_system=haproxy  proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Visitor Traffic Insight/Top 5 Urls**
```
proxy_cluster=* proxy_system=haproxy  proxy_cluster={{proxy_cluster}}
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Web Server Operations/Client Locations - 4xx Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Web Server Operations/Non 200 Response Status Codes**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Web Server Operations/Top 5 Clients Causing 4xx Errors**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Web Server Operations/Top 5 URLs Causing 4xx Responses**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
...
**HAProxy/Web Server Operations/Visitor Platforms**
```
proxy_cluster=* proxy_cluster = {{proxy_cluster}} proxy_system=haproxy
| json "log" as _rawlog nodrop 
| if (isEmpty(_rawlog), _raw, _rawlog) as haproxy_log_message
