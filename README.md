...
Total unique log searches: 11694
Total unique metric searches: 3749
...
Given that searches existed in a similar format in old and new apps you will often find duplicates within a specific file / topic with multiple origin path names.  For a 'deduped' list by use case name see the full or minimal format files:
- [log searches deduped](logs_searches.json)
- [log searches minimal fields](logs_searches_min.json)
- [metric searches deduped](metrics_searches.json)
- [metric searches minimal fields](metrics_searches_min.json)

## Full DB
- [final_searches.db.json](final_searches_db.json) - this the full export db with more fields such as the source app. It will contain many duplicates with over 20,000 total rows.
...
## md formatted Browsable Search Examples folder By App Name
